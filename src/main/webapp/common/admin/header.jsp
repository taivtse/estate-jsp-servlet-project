...
<header class="header">
    <div class="logo-container">
        <a href="/" class="logo">
            <img src="<c:url value='/template/admin/images/logo.png'/>" height="35" alt="Porto Admin"/>
        </a>
    ...
    <div class="header-right">
        <form action="pages-search-results.html" class="search nav-form">
            <div class="input-group input-search">
                <input typeArr="text" class="form-control" name="q" id="q" placeholder="Search...">
                <span class="input-group-btn">
								<button class="btn btn-default" typeArr="submit"><i class="fa fa-search"></i></button>
							</span>
            </div>
        </form>
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-toggle="dropdown">
                <figure class="profile-picture">
                    <img src="<c:url value='/template/admin/images/!logged-user.jpg'/>" alt="Joseph Doe"
                         class="img-circle"
